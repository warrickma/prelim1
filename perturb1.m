% parameters to preturb: rnap concentration; a
% ribosome concentration b
%transcription elongation rate c
%translation elongation rate d
%Kx e
%KL f
%perturb phase 1 w/o inducer added (550 min-600 min)
function [p1,p2,p3]=perturb1(A,S,tStart,tEnd,a,b,c,d,e,f)
